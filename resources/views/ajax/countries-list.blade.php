...
<div class="container">
    ...
    @include('ajax.edit-country-modal')
...
//ADD NEW COUNTRY
  $('#add-country-form').on('submit', function(e){
                ...
                // every page checkbox will not selected when user go to next paginagtion
            ...
            // To select all checkbox
             ...
             // when user click one by one the on the checkboxes and if he check all boxes then the select all checkboxes check will check automatically
        ...
        // user click select all checkbox then delete all button will show and hide automatically 
        ...
        // multiple records delete checkbox code
