...
<section class="mb-5">
        ...
        <input type="file" name="user_file" class="form-control-file" >
         ...
         <!-- <div class="form-group mt-4" stytle="margin-top: 1.5rem!important;    margin-bottom: 1rem;">
          ...
          <div class="row align-items-center mt-5">
            ...
            <div class="col">
              <input type="password" class="form-control" onChange="onChange()" placeholder="Confirm Password" name="cpassword" >
            </div>
            <input type="hidden" id="demo" name="verify_token">
          ...
          <div class="row justify-content-start mt-4">
            <div class="col" style="text-align:left !important;">
              ...
              <button class="btn btn-primary mt-4" name="submit" onclick="document.getElementById('demo').innerHTML = getRndInteger(0,50)">Register</button>
            </div>
          </div>
        </div>
          </form>
    ...
    <!-- <button > show</button>
    <input type="text" id="demo" name="verify_token" >
    <p id="demo"></p> -->
...
function getRndInteger(min, max) {
  ...
  document.getElementById('demo').value = rand ; 
}
</script>
  </script>
