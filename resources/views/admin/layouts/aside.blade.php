  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Tahir TLG</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <i class="fas fa-tasks"></i>
                  <p class="ml-2">Manage Products</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview menu-open mt-3">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_hotel" class="nav-link ">
                <i class="fa fa-plus-circle"></i>
                  <p class="ml-2">Add Hotel</p>
                </a>
              </li>

              <li class="nav-item">
                <a href="manage_hotel" class="nav-link ">
                <i class="fas fa-tasks"></i>
                  <p class="ml-2">Manage Hotels</p>
                </a>
              </li>
  ...
  <!-- dashboard stuff first containewrapper -->
